...
func (tx *Tx) init() {
	tx.Addresses = NewAddressesClient(tx.config)
	tx.Contacts = NewContactsClient(tx.config)
...
// applies a query, for example: Addresses.QueryXXX(), the query will be executed
